      ...
      <div className="min-h-screen bg-neutral-50">
        <div className="max-w-[1800px] mx-auto px-6 md:px-10 lg:px-12 py-12">
          <div className="text-center">
            <h1 className="text-2xl font-serif font-light mb-4">Error Loading Tasks</h1>
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl md:text-5xl font-serif font-light tracking-tight text-neutral-900">Tasks</h1>
          <p className="text-sm text-neutral-500 mt-2">Manage and track your project tasks</p>
        </div>
        <Button
