...
const mockUsers: User[] = [
  ...
  },
  {
    ...
    company: 'ABC Construction',
    status: 'active',
    lastLogin: '2025-12-10T08:15:00',
  },
  {
    id: '3',
    name: 'Mike Johnson',
    email: 'mike@subcontractor.com',
    phone: '(555) 345-6789',
    role: 'foreman',
    company: 'Johnson Painting',
    status: 'active',
    lastLogin: '2025-12-09T16:45:00',
  },
];
        ...
        <div className="bg-white rounded-lg border p-4">
          ...
          <div className="text-2xl font-bold text-gray-900 mt-1">
            {data.filter(u => {
              ...
              const diffMs = new Date().getTime() - new Date(u.lastLogin).getTime();
