  ...
  return (
    <div className="space-y-4">
      <Accordion type="multiple" className="w-full space-y-8">
        ...
        >
        <AccordionItem value="meetings" className="border rounded-lg px-2">
            ...
            <div className="space-y-2 pt-2">
              {meetings.length > 0 ? (
                meetings.slice(0, 5).map((meeting) => (
                  <div key={meeting.id} className="flex items-start justify-between p-3 bg-muted/50 rounded-lg">
        ...
        >
        <AccordionItem value="budget" className="border rounded-lg px-2">
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center justify-between w-full mr-4">
              <div className="flex items-center gap-2">
        ...
        >
        <AccordionItem value="prime-contracts" className="border rounded-lg px-2">
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center justify-between w-full mr-4">
              <div className="flex items-center gap-2">
            ...
            <div className="space-y-2 pt-2">
              {primeContracts.length > 0 ? (
                primeContracts.map((contract) => (
                  <div key={contract.id} className="flex items-start justify-between p-3 bg-muted/50 rounded-lg">
        ...
        >
        <AccordionItem value="change-orders" className="border rounded-lg px-2">
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center justify-between w-full mr-4">
              <div className="flex items-center gap-2">
        ...
        >
        <AccordionItem value="change-events" className="border rounded-lg px-2">
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center justify-between w-full mr-4">
              <div className="flex items-center gap-2">
        ...
        >
        <AccordionItem value="schedule" className="border rounded-lg px-2">
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center justify-between w-full mr-4">
              <div className="flex items-center gap-2">
        ...
        >
        <AccordionItem value="sov" className="border rounded-lg px-2">
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center justify-between w-full mr-4">
              <div className="flex items-center gap-2">
                <FileText className="h-5 w-5 text-muted-foreground" />
              ...
              {sov.length > 0 ? (
                <div>
                  ...
                  {sov.slice(0, 3).map((item) => (
                    <div key={item.id} className="p-3 bg-muted/50 rounded-lg mb-2">
        ...
        >
        <AccordionItem value="rfis" className="border rounded-lg px-2">
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center justify-between w-full mr-4">
              <div className="flex items-center gap-2">
                <FileText className="h-5 w-5 text-muted-foreground" />
            ...
            <div className="space-y-2 pt-2">
              {rfis.length > 0 ? (
                rfis.slice(0, 5).map((rfi) => (
                  <div key={rfi.id} className="flex items-start justify-between p-3 bg-muted/50 rounded-lg">
                    <div className="space-y-1 flex-1">
                      <div className="flex items-center gap-2">
        ...
        >
        <AccordionItem value="tasks" className="border rounded-lg px-2">
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center justify-between w-full mr-4">
              <div className="flex items-center gap-2">
        ...
        >
        <AccordionItem value="insights" className="border rounded-lg px-2">
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center justify-between w-full mr-4">
              <div className="flex items-center gap-2">
        ...
        >
        <AccordionItem value="submittals" className="border rounded-lg px-2">
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center justify-between w-full mr-4">
              <div className="flex items-center gap-2">
            ...
            <div className="space-y-2 pt-2">
              {submittals.length > 0 ? (
                submittals.slice(0, 5).map((submittal) => (
                  <div key={submittal.id} className="flex items-start justify-between p-3 bg-muted/50 rounded-lg">
                    <div className="space-y-1 flex-1">
        ...
        >
        <AccordionItem value="drawings" className="border rounded-lg px-2">
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center justify-between w-full mr-4">
              <div className="flex items-center gap-2">
            ...
            <div className="space-y-2 pt-2">
              {drawings.length > 0 ? (
                drawings.slice(0, 5).map((drawing) => (
                  <div key={drawing.id} className="flex items-start justify-between p-3 bg-muted/50 rounded-lg">
                    <div className="space-y-1 flex-1">
                      <p className="font-medium text-sm">{drawing.title || drawing.name}</p>
                      <div className="flex items-center gap-2 text-xs text-muted-foreground">
                ...
                <div className="text-center p-4">
                  <p className="text-sm text-muted-foreground mb-3">No drawings uploaded</p>
                  <Link href={`/${projectId}/drawings/upload`}>
                    <Button variant="outline" size="sm">
                      <Plus className="h-3 w-3 mr-1" /> Upload Drawing
                    </Button>
                  </Link>
                </div>
              )}
