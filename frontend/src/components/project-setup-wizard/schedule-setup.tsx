...
export function ScheduleSetup({ projectId, onNext, onSkip }: StepComponentProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <p className="text-muted-foreground">
          Upload project schedules and timeline documents. You can add more schedule documents anytime after setup.
        </p>
