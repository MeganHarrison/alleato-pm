...
export function DrawingsSetup({ projectId, onNext, onSkip }: StepComponentProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <p className="text-muted-foreground">
          Upload project drawings, plans, and blueprints. You can add more drawings anytime after setup.
        </p>
